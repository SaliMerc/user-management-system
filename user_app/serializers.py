...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = models.MyUser
        fields =['id', 'username', 'password', 'email', 'first_name', 'last_name', 'display_name', 'phone_number', 'city', 'country','profile_picture']
...
class CreateUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = models.MyUser
        fields =['id', 'username', 'password', 'email', 'first_name', 'last_name', 'display_name', 'phone_number', 'city', 'country']
